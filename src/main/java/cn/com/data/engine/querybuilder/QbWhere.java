...
public interface QbWhere
{
	...
	public enum QbWhereOperator
	{
		...
		public static QbWhereOperator getQbWhereOperator(String value) {
			        for (QbWhereOperator examType : QbWhereOperator.values()) {
			             if (StringUtils.equals(value, examType.value)) {
			                 return examType;
			            }
			         }
			         return null;
