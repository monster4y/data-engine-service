package cn.com.data.engine.querybuilder.test;
...
import cn.com.data.engine.querybuilder.QbSelect.QbJoinType;
import cn.com.data.engine.querybuilder.QbSelect.QbOrderBy;
import cn.com.data.engine.querybuilder.QbWhere.QbWhereOperator;
import cn.com.data.engine.querybuilder.generic.QbFactoryImp;
...
//		exceptionTests(fac);
	...
	static void selectTests(QbFactory fac)
	{
		...
		select.select(fac.newMax(fac.newStdField("col1"), "maxxy"))
			.from("myTable")
			.groupBy(fac.newQualifiedField("myTable", "col1")).groupBy(fac.newQualifiedField("myTable", "col2"));
